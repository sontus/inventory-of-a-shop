<div class="app-sidebar colored">
    <div class="sidebar-header">
        <a class="header-brand" href="{{route('dashboard')}}">
            <div class="logo-img">
               {{-- <img height="30" src="{{ asset('img/logo_white.png')}}" class="header-brand-img" title="> --}}
            </div>
        </a>
    ...
    <div class="sidebar-content">
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                @can('view_product|edit_product')
                    <div class="nav-item {{ ($segment1 == 'product*') ? 'active' : '' }}">
                        <a href="{{url('products')}}"><i class="ik ik-bar-chart-2"></i><span>Products</span></a>
                    </div>
                @endcan
